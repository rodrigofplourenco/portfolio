...
export default function Home() {
  return (
    <motion.div className='flex flex-col flex-grow px-6 pt-1' variants={routeAnimation} initial="initial" animate="animate" exit="exit">
      <h5 className='my-3 font-medium'>I describe my self as someone who's persistent, a quick learner and loves problem solving by using simple, efficient and scalable solutions.</h5>
        ...
        <motion.div className='grid gap-6 lg:grid-cols-2 lg:grid-rows-3' variants={stagger} initial="initial" animate="animate">
          {
            services.map(service => (
              <motion.div variants={fadeInUp} className='bg-gray-300 rounded-lg dark:bg-dark-200 lg:col-span-1'>
